...
<header>
    <ul class="col-lg-12" id="menu">
        ...
        <li class="button_right col-lg-offset-6 col-md-offset-0 col-lg-1 col-md-2 col-xs-2"><a href="index.php?action=login"><i class="fas fa-unlock-alt">&nbspConnexion</i></a></li>
        <?php } else {?>
        <li class="button_right col-lg-offset-6 col-md-offset-0 col-lg-1 col-md-2 col-xs-2"><a href="index.php?action=logout"><i class="fas fa-unlock-alt">Déconnexion</i></a></li>
        <?php } ?>
        <li class="button_right col-lg-1 col-md-2 col-xs-2"><a href="index.php?action=contact"><i class="fas fa-file-signature">&nbspContact</i></a></li>
